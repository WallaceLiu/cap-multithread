...
public class AtomicLongFieldUpdaterPairwiseTests {
    ...
    public static class AddAndGet_AddAndGet {
        @Actor
        public void actor1(S s, LongResult2 r) { r.r1 = s.u.addAndGet(s, 5); }
        @Actor
        public void actor2(S s, LongResult2 r) { r.r2 = s.u.addAndGet(s, 5); }
    }
    ...
    public static class AddAndGet_DecAndGet {
        ...
        public void actor1(S s, LongResult2 r) { r.r1 = s.u.addAndGet(s, 5); }
        @Actor
        public void actor2(S s, LongResult2 r) { r.r2 = s.u.decrementAndGet(s); }
    }
    ...
    public static class AddAndGet_GetAndAdd {
        ...
        public void actor1(S s, LongResult2 r) { r.r1 = s.u.addAndGet(s, 5); }
        @Actor
        public void actor2(S s, LongResult2 r) { r.r2 = s.u.getAndAdd(s, 5); }
    }
    ...
    public static class AddAndGet_GetAndDec {
        ...
        public void actor1(S s, LongResult2 r) { r.r1 = s.u.addAndGet(s, 5); }
        @Actor
        public void actor2(S s, LongResult2 r) { r.r2 = s.u.getAndDecrement(s); }
    }
    ...
    public static class AddAndGet_GetAndInc {
        ...
        public void actor1(S s, LongResult2 r) { r.r1 = s.u.addAndGet(s, 5); }
        @Actor
        public void actor2(S s, LongResult2 r) { r.r2 = s.u.getAndIncrement(s); }
    }
    ...
    public static class AddAndGet_GetAndSet {
        ...
        public void actor1(S s, LongResult2 r) { r.r1 = s.u.addAndGet(s, 5); }
        @Actor
        public void actor2(S s, LongResult2 r) { r.r2 = s.u.getAndSet(s, 10); }
    }
    ...
    public static class AddAndGet_IncAndGet {
        ...
        public void actor1(S s, LongResult2 r) { r.r1 = s.u.addAndGet(s, 5); }
        @Actor
        public void actor2(S s, LongResult2 r) { r.r2 = s.u.incrementAndGet(s); }
    }
    ...
    public static class AddAndGet_CAS {
        ...
        public void actor1(S s, LongResult2 r) { r.r1 = s.u.addAndGet(s, 5); }
        @Actor
        public void actor2(S s, LongResult2 r) { r.r2 = s.u.compareAndSet(s, 0, 20) ? 20 : 10; }
    }
    ...
    public static class AddAndGet_WCAS {
        ...
        public void actor1(S s, LongResult2 r) { r.r1 = s.u.addAndGet(s, 5); }
        @Actor
        public void actor2(S s, LongResult2 r) { r.r2 = s.u.weakCompareAndSet(s, 0, 20) ? 20 : 10; }
    }
    ...
    public static class AddAndGet_Set {
        ...
        public void actor1(S s, LongResult2 r) { r.r1 = s.u.addAndGet(s, 5); }
        @Actor
        public void actor2(S s, LongResult2 r) { s.u.set(s, 10); r.r2 = 0; }
    }
    ...
    public static class DecAndGet_DecAndGet {
        @Actor
        public void actor1(S s, LongResult2 r) { r.r1 = s.u.decrementAndGet(s); }
        @Actor
        public void actor2(S s, LongResult2 r) { r.r2 = s.u.decrementAndGet(s); }
    }
    ...
    public static class GetAndAdd_GetAndAdd {
        @Actor
        public void actor1(S s, LongResult2 r) { r.r1 = s.u.getAndAdd(s, 5); }
        @Actor
        public void actor2(S s, LongResult2 r) { r.r2 = s.u.getAndAdd(s, 5); }
    }
    ...
    public static class GetAndDec_GetAndDec {
        @Actor
        public void actor1(S s, LongResult2 r) { r.r1 = s.u.getAndDecrement(s); }
        @Actor
        public void actor2(S s, LongResult2 r) { r.r2 = s.u.getAndDecrement(s); }
    }
    ...
    public static class GetAndInc_GetAndInc {
        @Actor
        public void actor1(S s, LongResult2 r) { r.r1 = s.u.getAndIncrement(s); }
        @Actor
        public void actor2(S s, LongResult2 r) { r.r2 = s.u.getAndIncrement(s); }
    }
    ...
    public static class GetAndSet_GetAndSet {
        @Actor
        public void actor1(S s, LongResult2 r) { r.r1 = s.u.getAndSet(s, 5); }
        @Actor
        public void actor2(S s, LongResult2 r) { r.r2 = s.u.getAndSet(s, 10); }
    }
    ...
    public static class IncAndGet_IncAndGet {
        @Actor
        public void actor1(S s, LongResult2 r) { r.r1 = s.u.incrementAndGet(s); }
        @Actor
        public void actor2(S s, LongResult2 r) { r.r2 = s.u.incrementAndGet(s); }
    }
    ...
    public static class CAS_CAS {
        @Actor
        public void actor1(S s, LongResult2 r) { r.r1 = s.u.compareAndSet(s, 0, 5) ? 5 : 1; }
        @Actor
        public void actor2(S s, LongResult2 r) { r.r2 = s.u.compareAndSet(s, 0, 20) ? 20 : 10; }
    }
    ...
    public static class WCAS_WCAS {
        @Actor
        public void actor1(S s, LongResult2 r) { r.r1 = s.u.weakCompareAndSet(s, 0, 5) ? 5 : 1; }
        @Actor
        public void actor2(S s, LongResult2 r) { r.r2 = s.u.weakCompareAndSet(s, 0, 20) ? 20 : 10; }
    }
    ...
    public static class Set_Set {
        @Actor
        public void actor1(S s, LongResult1 r) { s.u.set(s, 5); }
        @Actor
        public void actor2(S s, LongResult1 r) { s.u.set(s, 10); }
        @Arbiter
        public void arbiter1(S s, LongResult1 r) { r.r1 = s.u.get(s); }
    }
}
