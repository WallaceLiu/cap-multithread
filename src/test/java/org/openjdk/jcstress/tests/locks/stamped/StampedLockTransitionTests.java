...
public class StampedLockTransitionTests {
    ...
    public static class OO_OO {
        @Actor
        public void actor1(S s, IntResult2 r) { r.r1 = s.optimistic_optimistic(); }
        @Actor
        public void actor2(S s, IntResult2 r) { r.r2 = s.optimistic_optimistic(); }
    }
    ...
    public static class OO_OR {
        ...
        public void actor1(S s, IntResult2 r) { r.r1 = s.optimistic_optimistic(); }
        @Actor
        public void actor2(S s, IntResult2 r) { r.r2 = s.optimistic_read(); }
    }
    ...
    public static class OO_OW {
        ...
        public void actor1(S s, IntResult2 r) { r.r1 = s.optimistic_optimistic(); }
        @Actor
        public void actor2(S s, IntResult2 r) { r.r2 = s.optimistic_write(); }
    }
    ...
    public static class OR_OW {
        @Actor
        public void actor1(S s, IntResult2 r) { r.r1 = s.optimistic_read(); }
        @Actor
        public void actor2(S s, IntResult2 r) { r.r2 = s.optimistic_write(); }
    }
    ...
    public static class RO_RO {
        @Actor
        public void actor1(S s, IntResult2 r) { r.r1 = s.read_optimistic(); }
        @Actor
        public void actor2(S s, IntResult2 r) { r.r2 = s.read_optimistic(); }
    }
    ...
    public static class RO_RR {
        ...
        public void actor1(S s, IntResult2 r) { r.r1 = s.read_optimistic(); }
        @Actor
        public void actor2(S s, IntResult2 r) { r.r2 = s.read_read(); }
    }
    ...
    public static class RO_RW {
        ...
        public void actor1(S s, IntResult2 r) { r.r1 = s.read_optimistic(); }
        @Actor
        public void actor2(S s, IntResult2 r) { r.r2 = s.read_write(); }
    }
    ...
    public static class RR_RW {
        @Actor
        public void actor1(S s, IntResult2 r) { r.r1 = s.read_read(); }
        @Actor
        public void actor2(S s, IntResult2 r) { r.r2 = s.read_write(); }
    }
    ...
    public static class WO_WO {
        @Actor
        public void actor1(S s, IntResult2 r) { r.r1 = s.write_optimistic(); }
        @Actor
        public void actor2(S s, IntResult2 r) { r.r2 = s.write_optimistic(); }
    }
    ...
    public static class WO_WR {
        ...
        public void actor1(S s, IntResult2 r) { r.r1 = s.write_optimistic(); }
        @Actor
        public void actor2(S s, IntResult2 r) { r.r2 = s.write_read(); }
    }
    ...
    public static class WO_WW {
        ...
        public void actor1(S s, IntResult2 r) { r.r1 = s.write_optimistic(); }
        @Actor
        public void actor2(S s, IntResult2 r) { r.r2 = s.write_write(); }
    }
    ...
    public static class WR_WW {
        @Actor
        public void actor1(S s, IntResult2 r) { r.r1 = s.write_read(); }
        @Actor
        public void actor2(S s, IntResult2 r) { r.r2 = s.write_write(); }
    }
